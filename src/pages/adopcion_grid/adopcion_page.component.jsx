...
const AdopcionPage = () => {
    ...
    const [mascotas, setMascotas] = useState(masco);
    ...
    useEffect(() => {
        console.log(filtros);
        if(filtros.type!=""){
            mascotasFiltradas = mascotasFiltradas.filter(mascota => mascota.type.toLocaleLowerCase().includes(filtros.type.toLocaleLowerCase()))
        }
        if(filtros.breed!=""){
            mascotasFiltradas = mascotasFiltradas.filter(mascota => mascota.type.toLocaleLowerCase().includes(filtros.breed.toLocaleLowerCase()))
        }
        if(filtros.city!=""){
            mascotasFiltradas = mascotasFiltradas.filter(mascota => mascota.city.toLocaleLowerCase().includes(filtros.city.toLocaleLowerCase()))
        }
