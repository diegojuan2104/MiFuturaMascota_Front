...
import { Carousel, Item, Modal, Button } from "react-bootstrap";
...
const MiMascotaDetalles = () => {
  ...
  const profileSelected = auto_description => {
    handleShow();
    setDescription(auto_description);
  }
  ...
  return (
    <div>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>{description ? description :"No tiene descripción"}</Modal.Body>
        <Modal.Footer>
                ...
                <tbody>
                  {interesados.map((interesado) => (
                    <tr>
                      ...
                      <td> <button
                              className=" "
                              onClick={profileSelected.bind(this, interesado.auto_description)}
                            >
                              Ver perfil
                          </button></td>
                    </tr>
